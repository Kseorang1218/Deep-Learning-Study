...
python latent_experiment_wdcnn_AE.py --latent_size 2048  
python latent_experiment_wdcnn_AE.py --latent_size 1024
python latent_experiment_wdcnn_AE.py --latent_size 512
...
# python latent_experiment_wdcnn_AE.py --latent_size 50
# python latent_experiment_wdcnn_AE.py --latent_size 4
# python latent_experiment_wdcnn_AE.py --latent_size 2
