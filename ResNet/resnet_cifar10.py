...
# 그래프 그리고 저장
DrawGraph(test_acc_list, test_loss_list, 'resnet18 test', mode='test', path=PATH+'test.png')
DrawGraph(train_acc_list, train_loss_list, 'resnet18 train', mode='train', path=PATH+'train.png')
# 최대 test 정확도 출력
