...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=5, block=InvertedResidual, dropout=0.2, width_mult=1.0):
        super().__init__()
        ...
        layers.append(nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=input_channel, kernel_size=3, stride=2, 
